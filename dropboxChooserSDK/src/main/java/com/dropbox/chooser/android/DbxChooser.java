...
public class DbxChooser {
     ...
     * supplied Activity.
     */
    public void launch(AppCompatActivity act, int requestCode) throws ActivityNotFoundException {
        final AppCompatActivity mAct = act;
        ActivityLike thing = new ActivityLike() {
            ...
            public FragmentManager getFragmentManager() {
                try {
                    return mAct.getSupportFragmentManager();
...
*/
    ...
    public static class Result {
         ...
         * If the request code doesn't match the one provided to {@link DbxChooser#launch(AppCompatActivity, int)} or if the result code
         * was anything but {@link AppCompatActivity#RESULT_OK}, this class will be unable to extract useful values.
         */
